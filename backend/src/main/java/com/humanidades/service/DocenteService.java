...
import com.humanidades.repository.DocenteRepository;
...
public class DocenteService  {
    ...
    private com.humanidades.repository.DocenteRepository docenteRepository;
    ...
    public List<Docente> findLikeNombreApellido(String cadena) throws Exception {
        return docenteRepository.findLikeNombreApellido(cadena);
    }
    ...
    private void validar(Docente docente) throws Exception {
        ...
        /*    if(docenteRepository.FindPersonaByDNI(docente.getDni(), docente.getId())){
         throw new Exception("Ya existe una docente con el DNI ingresado");
         }//fin if*/
        if (docenteRepository.findDocenteDni(docente.getDni().trim()) != null) {
    ...
    public List<Docente> findByDocenteDni(String dni) {
        return docenteRepository.findByDocenteDni(dni);
    }
}
